...
/**
 * Default implementation of IMapCollection
 * @see WizDevelop\PhpValueObject\Collection\Map\IMapCollection
 * @uses WizDevelop\PhpValueObject\Collection\MapCollection
 * @template TValue
 */
trait MapCollectionDefault
{
    ...
    #[Override]
    final public function concat(IMapCollection $other): static
    {
        $elements = $this->elements;
    ...
    #[Override]
    final public function merge(IMapCollection $other): static
    {
