...
abstract readonly class StringValue implements IStringValue
{
    ...
    public static function tryFrom(string $value): Result
    {
        return static::isValid($value)
            ...
            ->andThen(static fn () => Result\ok(new static($value)));
    }
     ...
     */
    private static function isLengthValid(string $value): Result
    {
     ...
     * @return Result<bool,StringValueError>
     */
    private static function isRegexValid(string $value): Result
    {
        $regex = static::regex();
